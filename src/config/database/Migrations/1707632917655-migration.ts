...
export class Migration1707632917655 implements MigrationInterface {
    name = 'Migration1707632917655'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "note" ("id" SERIAL NOT NULL, "title" character varying(200) NOT NULL, "content" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, CONSTRAINT "PK_96d0c172a4fba276b1bbed43058" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."shared_note_permission_enum" AS ENUM('read-only', 'read-write', 'owner')`);
        await queryRunner.query(`CREATE TABLE "shared_note" ("id" SERIAL NOT NULL, "permission" "public"."shared_note_permission_enum" NOT NULL DEFAULT 'read-only', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "byuserId" integer NOT NULL, "toUserId" integer NOT NULL, "noteId" integer NOT NULL, CONSTRAINT "PK_99c62b91170242dd70df9b7a28d" PRIMARY KEY ("id"))`);
